...
export default function ComposerActionsPopover({ children }) {
  ...
  const moreActions = [
    ...
    {
      icon: () => (
        <div className="h-4 w-4 rounded bg-linear-to-br from-blue-500 to-green-500 flex items-center justify-center">
    ...
    {
      icon: () => (
        <div className="h-4 w-4 rounded bg-linear-to-br from-blue-600 to-blue-400 flex items-center justify-center">
          <div className="h-2 w-2 bg-white rounded-full" />
        </div>
      ),
    ...
    {
      icon: () => (
        <div className="h-4 w-4 rounded bg-linear-to-br from-teal-500 to-teal-400 flex items-center justify-center">
          <div className="h-2 w-2 bg-white rounded-full" />
        </div>
      ),
