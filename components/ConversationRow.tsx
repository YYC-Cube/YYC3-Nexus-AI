...
interface ConversationRowProps {
  data: { id: string; title: string; preview: string; timestamp: string; pinned?: boolean; messages?: unknown[]; messageCount?: number; updatedAt?: string }
  active: boolean
...
export default function ConversationRow({ data, active, onSelect, onTogglePin, showMeta = true }: ConversationRowProps) {
