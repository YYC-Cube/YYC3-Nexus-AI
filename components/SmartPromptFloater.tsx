    ...
    <AnimatePresence>
      {isVisible && intentResult && (
        <motion.div
          ...
          className="absolute bottom-full left-0 mb-2 w-full sm:w-96 rounded-xl border border-zinc-200 bg-white/95 backdrop-blur-xs shadow-lg dark:border-zinc-800 dark:bg-zinc-900/95 overflow-hidden"
        >
          {/* 渐变装饰条 */}
