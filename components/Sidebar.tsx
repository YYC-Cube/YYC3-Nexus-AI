...
interface SidebarProps {
  ...
  collapsed: { pinned: boolean; recent: boolean; folders: boolean; templates: boolean }
  setCollapsed: (v: { pinned: boolean; recent: boolean; folders: boolean; templates: boolean } | ((prev: { pinned: boolean; recent: boolean; folders: boolean; templates: boolean }) => { pinned: boolean; recent: boolean; folders: boolean; templates: boolean })) => void
...
export default function Sidebar({
  ...
  const handleCreateTemplate = (templateData: { name: string; content: string; snippet?: string; id?: string; createdAt?: string; updatedAt?: string }) => {
    if (editingTemplate) {
      ...
      >
        <div className="flex items-center justify-center border-b border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
          <button
            ...
            className="rounded-xl p-2 hover:bg-zinc-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 dark:hover:bg-zinc-800"
        ...
        <div className="flex flex-col items-center gap-4 pt-4 my-5">
          ...
          <button
            ...
            className="rounded-xl p-2 hover:bg-purple-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-purple-500 dark:hover:bg-purple-900/30"
            title="AI 代码助手"
          >
          ...
          <button
            ...
            className="rounded-xl p-2 hover:bg-blue-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 dark:hover:bg-blue-900/30"
            title="AI学习助手"
          >
          ...
          <button
            ...
            className="rounded-xl p-2 hover:bg-amber-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-amber-500 dark:hover:bg-amber-900/30"
            title="提示词库"
          >
          ...
          <button
            ...
            className="rounded-xl p-2 hover:bg-green-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-green-500 dark:hover:bg-green-900/30"
            title="学习路径"
          >
          ...
          >
            <div className="flex items-center gap-2 border-b border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                <div className="grid h-8 w-8 place-items-center bg-linear-to-br from-blue-500 to-indigo-500 text-white shadow-xs dark:from-zinc-200 dark:to-zinc-300 dark:text-zinc-900 rounded-lg">
              ...
              <div className="ml-auto flex items-center gap-1">
                <button
                  ...
                  className="hidden md:block rounded-xl p-2 hover:bg-zinc-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 dark:hover:bg-zinc-800"
                ...
                <button
                  onClick={onClose}
                  className="md:hidden rounded-xl p-2 hover:bg-zinc-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 dark:hover:bg-zinc-800"
                  aria-label="Close sidebar"
                >
            ...
            <div className="px-3 pt-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-full border border-zinc-200 bg-white py-2 pl-9 pr-3 text-sm outline-hidden ring-0 placeholder:text-zinc-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-zinc-800 dark:bg-zinc-950/50"
                />
              </div>
            </div>
            ...
            <div className="px-3 pt-3">
              <button
                onClick={createNewChat}
                className="flex w-full items-center justify-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-white shadow-xs transition hover:bg-zinc-800 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 dark:bg-white dark:text-zinc-900 bg-blue-700"
            ...
            <nav className="mt-4 flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-2 pb-4">
              ...
              <SidebarSection
                ...
                onToggle={() => setCollapsed((s: typeof collapsed) => ({ ...s, pinned: !s.pinned }))}
              >
                {pinned.length === 0 ? (
              ...
              <SidebarSection
                ...
                onToggle={() => setCollapsed((s: typeof collapsed) => ({ ...s, recent: !s.recent }))}
              >
                {recent.length === 0 ? (
                  <div className="select-none rounded-lg border border-dashed border-zinc-200 px-3 py-3 text-center text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400">
                    {t("sidebar.noConversations")}
              ...
              <SidebarSection
                ...
                onToggle={() => setCollapsed((s: typeof collapsed) => ({ ...s, folders: !s.folders }))}
              >
                <div className="-mx-1">
                  <button
              ...
              <SidebarSection
                ...
                onToggle={() => setCollapsed((s: typeof collapsed) => ({ ...s, templates: !s.templates }))}
              >
                <div className="-mx-1">
                  <button
            ...
            <div className="mt-auto border-t border-zinc-200/60 px-3 py-3 dark:border-zinc-800">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-lg px-2 py-2 text-sm hover:bg-zinc-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-500 dark:hover:bg-zinc-800"
                >
