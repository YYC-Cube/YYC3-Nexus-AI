...
import { Copy, Edit3, FileText, MoreHorizontal, Trash2 } from "lucide-react"
import { AnimatePresence, motion } from "motion/react"
import { useEffect, useRef, useState } from "react"

interface TemplateRowProps {
  template: { id: string; name: string; content: string; snippet?: string; createdAt?: string }
  onUseTemplate: (t: { id: string; name: string; content: string; snippet?: string }) => void
  onEditTemplate: (t: { id: string; name: string; content: string; snippet?: string }) => void
