...
interface CreateTemplateModalProps {
  isOpen: boolean
  onClose: () => void
  onCreateTemplate: (template: { name: string; content: string; snippet?: string; id?: string; createdAt?: string; updatedAt?: string }) => void
  editingTemplate?: { id: string; name: string; content: string; snippet?: string; createdAt?: string; updatedAt?: string } | null
}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-300 px-4 py-3 text-sm outline-hidden focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-zinc-700 dark:bg-zinc-800"
                  autoFocus
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={8}
                  className="w-full rounded-lg border border-zinc-300 px-4 py-3 text-sm outline-hidden focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-zinc-700 dark:bg-zinc-800 resize-none"
                />
              </div>
